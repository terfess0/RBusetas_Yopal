...
class AdapterReportsAdmin(
    private var reports: List<DatoReport>,
    private var viewModelRep: ReportViewModel,
    private var lifeCycleOwnerInst: LifecycleOwner
) :
    ...
    override fun onBindViewHolder(holder: HolderReportsAdmin, position: Int) {
        holder.showReports(reports[position], position, viewModelRep, position)
    }
